                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-12 p-0">
                            <div id="hero-slide" className="carousel carousel-fade slide" data-bs-ride="carousel">
                                ...
                                <button className="carousel-control-prev" style={{marginTop:"300px"}} type="button" data-bs-target="#hero-slide" data-bs-slide="prev">
                                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span className="visually-hidden">Previous</span>
                                </button>

                                <button className="carousel-control-next" style={{marginTop:"300px"}} type="button" data-bs-target="#hero-slide" data-bs-slide="next">
